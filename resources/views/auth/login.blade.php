                    ...
                    <div class="row align-items-center row-login">
                        ...
                        <div class="col-lg-5">
                            ...
                            @csrf
                                ...
                                <a href="{{ route('login') }}" class="btn btn-success btn-block w-75 mt-4" onclick="event.preventDefault(); document.getElementById('login-form').submit();" style="cursor: pointer;">
